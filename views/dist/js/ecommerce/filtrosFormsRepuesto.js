$(document).ready(function () {
  ...
  function enviarFiltrosPorGet() {
    ...
    if (idMarca) queryParams.push("marca=" + encodeURIComponent(idMarca));
    if (idModelo) queryParams.push("modelo=" + encodeURIComponent(idModelo));
    if (idMotor) queryParams.push("motor=" + encodeURIComponent(idMotor));
